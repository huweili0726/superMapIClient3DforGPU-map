window.themeConfig = [
    {
      ...
      "exampleBgColor": "#FFFFFF",
      "scrollbarThumbColor": "#555555",
      "bannerNavBgColor": "#FFFFFF",
      "maskBgcColor": "rgba(0, 0, 0, 0.65)",
      "maskTextColor": "rgba(255,255,255,0.85)",
      "menuWrapShadow": "var(--alpha08)",
      "dropShadow": "rgba(0, 0  ,0, 0.14)",
      "dropShadowBgcColor": "rgba(0, 0  ,0, 0.04)",
      "pcStyleShadow": "rgba(0,0,0,0.06)",
      "cardShadow": "rgba(0,0,0,0.04)",
      "cardShadowHover": "rgba(0,0,0,0.1)",
      "examplePicBoder": "rgba(225,225,225,0.08)",
      "sourcePopBgColor": "#FFFFFF",
    },
    {
      "label": "dark",
      ...
      "whatsNewBackgroundColor": "#1F1F1F",
      "textColorThird": "var(--alpha45)",
      "iconColor": "var(--alpha100)",
      ...
      "exampleBgColor": "#262626",
      "scrollbarThumbColor": "#555555",
      "bannerNavBgColor": "#1F1F1F",
      "maskBgcColor": "rgba(0, 0, 0, 0.65)",
      "maskTextColor": "rgba(255,255,255,0.85)",
      "menuWrapShadow": "rgba(0, 0  ,0, 0.04)",
      "dropShadow": "rgba(0, 0  ,0, 0.35)",
      "dropShadowBgcColor": "rgba(255, 255  ,255, 0.04)",
      "pcStyleShadow": "rgba(0,0,0,0.06)",
      "cardShadow": "#FFFFFF",
      "cardShadow": "rgba(0, 0, 0, 0.04)",
      "cardShadowHover": "rgba(0, 0 ,0 , 0.1)",
