...
function setRootStyle (theme) {
    ...
    var apiIframe = document.querySelector('.api-iframe');
    var iframeRootStyleTag = (apiIframe && apiIframe.contentWindow.document.getElementById(antdStyleId));
    iframeRootStyleTag && (iframeRootStyleTag.innerHTML = rootStyle);
}
