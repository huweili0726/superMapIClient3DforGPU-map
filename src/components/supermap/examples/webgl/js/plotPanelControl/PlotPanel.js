...
function createDrawNodes(treeNode, iconNode, drawControl, serverUrl){
    var drawNodeClick = function(){
        if(drawControl !== null){
            ...
            let url = "";
            if (this.symbolCode == 20) {
                url = "./js/plotPanelControl/BasicCell/20.png";
            }
            drawControl.setAction(this.libID,this.symbolCode,url);
...
function addBasicCellTreeNodes(treeData){
    ...
    var symbolCode = [24, 28, 29, 31, 34, 410, 32, 590, 360, 390, 400, 350, 26, 370, 380, 44, 48, /*320,*/
        1019, 1022, /*1024, 321,1023,*/  1025, 1013, 1014, 3701, 3801, 4401,20 /*1016, 1017, 1026,*/ /*1001 1003, 1004*/
    ...
    var symbolName = ["折线", "平行四边形", "圆", "椭圆", "注记", "正多边形", "多边形", "贝塞尔曲线", "闭合贝塞尔曲线",
        ...
        /*"标注框", "多角标注框","自由线",*/ "节点链", "跑道形", "八字形", "弓形","扇形","弧线","图片"/*"箭头线", "沿线注记", "线型标注", "对象间连线"*/
        /*"多边形区域", "扇形区域"*/
        , "平行平耳箭头", "梯形平耳箭头", "普通贝塞尔箭头", "折线三角箭头", "贝塞尔燕尾箭头", "普通折线箭头", "普通贝塞尔箭头（不随图）", "折线三角箭头（不随图）", "贝塞尔燕尾箭头（不随图）", "普通折线箭头（不随图）", "组合箭头", "平行尖耳箭头",  "路径2"
